...
<style>
  ...
  <body>
		<?php
		  setHeaderLecturer("courses", "Update course");
		?>
						...
						<?php
							...
							echo '
										...
										<div class="form-group mt-3">
											...
											<textarea class="form-control" placeholder="Enter description" name="desc" >'.$row['description'].'</textarea>
										</div>
										<div class="form-group mt-3">
							...
							echo '		<input class="form-control" type="hidden" name="id" value="'.$_POST['id'].'">
									...
									<div class="mt-3">
										<a href="lecturer_dashboard.php" class="btn btn-danger">Cancel</a>
