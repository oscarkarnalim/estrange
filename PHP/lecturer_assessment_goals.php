<?php
	...
	if(isset($_GET['id']) == true && $_GET['id'] != ''){
		...
		$sql = "SELECT course.name FROM course 
				...
				course.creator_id = '".$_SESSION['user_id']."'";
...
<script type="text/javascript" src="datatables/responsive.bootstrap5.min.js"></script>
  ...
  <body>
		<?php
		  setHeaderLecturer("courses", "Course game: collaborative goals");
		?>
				...
				<div class="row d-flex justify-content-center">
					...
					<div class="col-md-4">
						<div class="row d-flex justify-content-center">
							...
							<div class="col-md-12">
								<button class="btn btn-primary w-100 mt-4" onclick="window.open('lecturer_game.php?id=<?php echo $courseID; ?>', '_self');">Return to game home</button>
							</div>
						</div>
					</div>
				</div>		
