  ...
  <body>
		<?php
		  if($_SESSION['role'] == 'lecturer')
			  setHeaderLecturer("colecturer courses", "Student enrollment for co-lecturer course");
		  else
			  setHeaderStudent("colecturer courses", "Student enrollment for co-lecturer course");
		?>
			...
			<div class="row d-flex justify-content-center align-items-center" style="min-height:50vh">
				<div class="col-md-6">
					...
					<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
						...
						<div class="form-group mt-3">
							<a href="colecturer_students.php" class="btn btn-danger">Cancel</a>
