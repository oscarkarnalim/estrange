<?php
	...
	if ($result->num_rows > 0) {
		// if the student is enrolled to at least one gamified course, redirect to student_game
		header('Location: student_game.php');
		exit;
	}
?>
<html>
				...
				if($human_language == "en"){
            			...
            			<div class="row d-flex justify-content-center align-items-center" style="min-height: 80vh">
            				<div class="col-md-6">
            					<div class="card mx-auto text-center border-0">	
            						<h1>You are not enrolled to any courses with game feature.</h1>
            					</div>
            				</div>
            			</div>
            		</div>
					...
					<div class="container mt-3">
            			<div class="row d-flex justify-content-center align-items-center" style="min-height: 80vh">
            				<div class="col-md-6">
            					<div class="card mx-auto text-center border-0">	
            						<h1>Kamu tidak terdaftar di mata kuliah yang memiliki fitur gamifikasi.</h1>
            					</div>
            				</div>
            			</div>
            		</div>
