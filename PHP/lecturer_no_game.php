<?php
	...
	if ($result->num_rows > 0) {
		...
		header('Location: lecturer_game.php');
		exit;
	}
?>
<html>
...
<script type="text/javascript" src="datatables/responsive.bootstrap5.min.js"></script>
 ...
 <style>
  ...
  <body>
		<?php
		  setHeaderLecturer("courses", "Course game");
		?>

		<div class="bodycontent">
			<div class="infotitle"> Course game </div>
			<div class="content">
			<?php 
			...
			<button class="btn btn-primary w-50" onclick="window.open('lecturer_dashboard.php', '_self');">Return to courses</button>
		</div>
