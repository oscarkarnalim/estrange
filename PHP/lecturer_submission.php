...
<script type="text/javascript" src="datatables/responsive.bootstrap5.min.js"></script>
  ...
  <body>
		<?php
		  setHeaderLecturer("courses", "Assessment submissions");
		?>
		<div class="container mt-3">
			<div class="bodycontent swap-rows">
				...
				<div class="row d-flex justify-content-center align-items-center mb-3">
					...
					<?php
						echo "<button id='return-assessment'  class='btn btn-primary mb-2 addcourse' onclick=\"window.open('lecturer_assessments.php', '_self');\">Return to assessments</button>";
						echo "<script>
				...
				<div class="nosubmissionstudents mb-3"> <b>Students who have not submitted their work:</b> 
					<?php
					...
					<table id="lecturerAssessmentTable" class="table table-bordered table-striped responsive nowrap" style="width:100%" >
						<thead>		
							<tr>
								<th>Submitter</th>
								<th>File name</th>
													...
													if ($resultt->num_rows > 0) {
														...
														echo "
																<form class=\"invisform\" action=\"user_suspicion_report.php\" method=\"post\">
																	...
																	<button class=\"btn btn-warning w-100\" type=\"submit\">similarity alert</button>
																</form>
																";
														}
												echo "
				...
				<?php
					...
					if ($result->num_rows > 0) {
						...
						if ($resultt->num_rows > 0) {
							...
							if($rowt['similarity_report_path'] == 'null'){
								...
								echo "<div class=\"col-md-3\">
										<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em\">Too few subs for sim. report</button>
										</div>
									";
							}
							else{
								...
								echo "<div class=\"col-md-3\">
										<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em \" onclick=\"window.open('colecturer_download_sim_report.php?id=".$_SESSION['assessment_id']."', '_self');\">Download sim. report</button>
									</div>
										";
							}
						}else{
							...
							if ($resultt->num_rows > 0) {
								echo "<div class=\"col-md-3\">
										<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em\">Sim. report is being generated</button>
										</div>
									";
							}else{
								echo "<div class=\"col-md-3\">
										<button class=\"btn btn-secondary mb-4 w-100 \" style=\"font-size:0.8em\">Earlier than due date for sim. report</button>
										</div>	
									";
							}
						}
						...
						echo "
						<div class=\"col-md-2\">
							<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em \" onclick=\"window.open('colecturer_download_metadata.php', '_self');\">Download metadata</button>
						</div>	

						<div class=\"col-md-4\">
							<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em \" onclick=\"window.open('colecturer_download_all_last_code.php', '_self');\">Download only last attempt submissions</button>
						</div>	

						<div class=\"col-md-2\">	
							<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.8em \" onclick=\"window.open('colecturer_download_all_code.php', '_self');\">Download all</button>
						</div>	
							";
					}
					?>
	...
	// 	} );
    // });
	new DataTable('#lecturerAssessmentTable', {
    	responsive: true,
    	order: [[4, 'desc']],
		// columnDefs: [
