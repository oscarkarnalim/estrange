...
<script type="text/javascript" src="datatables/responsive.bootstrap5.min.js"></script>
  ...
  <body>
		<?php
			...
			else setHeaderLecturer("colecturer courses", "Assessment submissions for co-lecturer course");
		?>
		...
		<div class="container-fluid px-5 mt-3">
			<div class="bodycontent">
				...
				<div class="row d-flex justify-content-center align-items-center mb-3">
					...
					<div class="col-md-6 buttontambah">
						<!-- <button class="btn btn-primary mb-2 addcourse" onclick="window.open('colecturer_assessments.php', '_self');">Return to assessments</button> -->
						<?php
						echo "<button id='return-assessment'  class='btn btn-primary mb-2 addcourse' onclick=\"window.open('colecturer_assessments.php', '_self');\">Return to assessments</button>";
						echo "<script>
			...
			<div class="tablecontainer">
				<table id="colecturerAssessmentTable" class="table table-bordered table-striped responsive nowrap" style="width:100%" >
					<thead>
						<tr>
							<th>Submitter</th>
							<th>File name</th>
				...
				<div class="row d-flex justify-content-center align-items-center mb-3 me-auto">
				<?php
					...
					if ($result->num_rows > 0) {
						...
						if ($resultt->num_rows > 0) {
							...
							if($rowt['similarity_report_path'] == 'null'){
							  ...
							  ";
    							...
    							echo "
								<div class=\"col-md-3\">
									<button class=\"btn btn-primary mb-4 w-100 \" onclick=\"window.open('colecturer_download_sim_report.php?id=".$_SESSION['assessment_id']."', '_self');\">Download sim. report</button>
								</div>";
							}
						}else{
						    ...
						    if ($resultt->num_rows > 0) {
								...
								echo "<div class=\"col-md-3\">
										<button class=\"btn btn-primary mb-4 w-100 \" style=\"font-size:0.9em\">Earlier than due date for sim. report</button>
									  </div>	
							";
						    }
						}
						...
						echo "
							<div class=\"col-md-2\">
							<button class=\"btn btn-primary mb-4 w-100 \" onclick=\"window.open('colecturer_download_metadata.php', '_self');\">Download metadata</button>
						</div>	

						<div class=\"col-md-4\">
							<button class=\"btn btn-primary mb-4 w-100 \" onclick=\"window.open('colecturer_download_all_last_code.php', '_self');\">Download only last attempt submissions</button>
						</div>	

						<div class=\"col-md-2\">	
							<button class=\"btn btn-primary mb-4 w-100 \" onclick=\"window.open('colecturer_download_all_code.php', '_self');\">Download all</button>
						</div>	
							";
					}
					?>
