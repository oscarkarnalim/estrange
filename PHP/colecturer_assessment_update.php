...
<html>
  ...
  <body onload="initialise();" >
		<?php
			...
			else setHeaderStudent("colecturer courses", "Update assessments for co-lecturer course");
		?>
		...
		<?php
			...
			echo '		</select>
					...
					<input class="form-control" type="hidden" name="old_close_time" value="'.$myOldCloseTime.'">
				</div>
				<div class="mt-3">
				<a href="colecturer_assessments.php" class="btn btn-secondary">Cancel</a>
