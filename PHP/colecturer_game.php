							...
							<div class="tablecontainer">
								<table id="leaderboard" class="table table-bordered table-striped responsive nowrap"  style="width:100%">
									...
									<tbody>
										<?php
											$counter = 1;
											// get top N students based on their points
											// the N threshold is placed in the javascript function
											$arr = array();
												...
												while($row = $result->fetch_assoc()){
													...
													if ($resultt->num_rows > 0) {
														while($rowt = $resultt->fetch_assoc()){
															$mySubmissionPoints = $mySubmissionPoints + $rowt['orig'];
															$myEfficiencyPoints = $myEfficiencyPoints + $rowt['eff'];
															$myQualityPoints = $myQualityPoints + $rowt['qual'];
														}
													}
