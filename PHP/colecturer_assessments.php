    ...
    <div class="bodycontent">
		<div class="row d-flex justify-content-center align-items-center mb-3">
				...
				<div class="col-md-6 buttontambah">
					<!-- <button class="btn btn-primary addcourse" onclick="window.open('colecturer_courses.php', '_self');">Return to co-lecturer courses</button> -->
					<?php
						echo "<button id='return-course'  class='btn btn-primary addcourse' onclick=\"window.open('colecturer_courses.php', '_self');\">Return to co-lecturer courses</button>";
						echo "<script>
					...
					?>
            		<button class="btn btn-primary addcourse" onclick="window.open('colecturer_assessment_add.php', '_self');">Add assessment</button>
				</div>
			</div>
						...
						<?php
							...
							if ($result->num_rows > 0) {
									while($row = $result->fetch_assoc()) {
											...
											echo "
													<td class=\"tdactions\">
														<form class=\"invisform\" action=\"colecturer_submission.php\" method=\"post\">
														...
														<form class=\"invisform\" action=\"colecturer_assessment_update.php\" method=\"post\">
															<input type=\"hidden\" name=\"id\" value=\"".$row['assessment_id']."\">
															<button class=\"btn btn-warning w-100\" type=\"submit\">update</button>
														</form>
														<div class=\" mb-3\" action=\"". htmlentities($_SERVER['PHP_SELF']). "\" method=\"post\">
														...
														<div class=\"link\">
															...
															<button class=\"btn btn-primary ms-3\" onclick=\"copy_assessment_link('assessment_link".$row['assessment_id']."');\">copy</button>
														</div>
													</td>
												</tr>
