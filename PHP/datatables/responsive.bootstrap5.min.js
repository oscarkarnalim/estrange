...
!(function (n) {
  ...
  'function' == typeof define && define.amd
    ? define(['jquery', 'datatables.net-bs5', 'datatables.net-responsive'], function (e) {
  ...
  var r,
    ...
    a = e.bootstrap;
  return (
    (n.Responsive.bootstrap = function (e) {
      a = e;
    }),
    (o.modal = function (i) {
      return (
        ...
        function (e, d, n, o) {
          if (s.fn.modal) {
            if (d) {
              ...
              i &&
                i.header &&
                ((t = (a = f.find('div.modal-header')).find('button').detach()),
                a
                  .empty()
                  .append('<h4 class="modal-title">' + i.header(e) + '</h4>')
                  .append(t)),
                f.find('div.modal-body').empty().append(n()),
