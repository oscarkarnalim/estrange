...
<script type="text/javascript" src="datatables/responsive.bootstrap5.min.js"></script>
  ...
  <body>
		<?php
		  setHeaderAdmin("courses", "Course co-lecturers");
		?>
		...
		<div class="bodycontent">
			<div class="row d-flex justify-content-center align-items-center mb-3">
				...
				<div class="col-md-6 buttontambah">
					<button class="btn btn-primary addcourse mb-2" onclick="window.open('admin_dashboard.php', '_self');">Return to dashboard</button>
					<button class="btn btn-primary addcourse mb-2" onclick="window.open('admin_enrollment_colecturer.php', '_self');">Enroll co-lecturer(s)</button>

				</div>
			<div class="tablecontainer">
				<table id="adminColecturerTable" class="table table-bordered table-striped responsive nowrap" style="width:100%" >
					<thead>
						<tr>
							<th>Username</th>
							<th>Name</th>
	...
	// 	} );
    // });
	new DataTable('#adminColecturerTable', {
    	responsive: true,
		// columnDefs: [
