...
public class GreedyStringTiling {
	...
	// get matched tiles with an optimized version of RKRGST, ignoring search of the largest possible length
	public static ArrayList<GSTMatchTuple> getMatchedTiles(Object[] s1, Object[] s2, int minimalMatchingLength) {
		...
		// scan the tokens and check for similarity
		scanpattern(minimalMatchingLength);
		markStrings(minimalMatchingLength, tiles);
		return tiles;
	}

	// get matched tiles with an optimized version of RKRGST, ignoring search of the largest possible length
	public static ArrayList<GSTMatchTuple> getMatchedTilesWithPredefinedMarkedArrays(Object[] newP,
			boolean[] newMarkedP, Object[] newT, boolean[] newMarkedT, int minimalMatchingLength) {
		// renew all data structure needed
		ArrayList<GSTMatchTuple> tiles = new ArrayList<GSTMatchTuple>();
		matchList = new ArrayList<Queue<GSTMatchTuple>>();
	...
	/*
	 * Returns the first postion of an unmarked token after the next tile. case 1:
